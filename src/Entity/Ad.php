...
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre déscription ne peut pas faire moins de 100 caractères ! ")
     */
    private $content;
    ...
    public function getAvgRatings(){
        ...
        // Faire la divisions pour avoir la moyenne
     ...
     * @return [array] [Un tableau d'objet DateTime réprésentant les jours d'occupation ]
     */
