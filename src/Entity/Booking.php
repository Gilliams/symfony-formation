...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être ulterieur à la date du jour !")
     */
    private $startDate;
     ...
     * @Assert\GreaterThan(propertyPath="startDate", message="La date de départ doit être ulterieur à la date d'arrivée !")
     */
    private $endDate;
    ...
    /**
     * Callback appelé à chaque fois qu'on crée une résérvation
     * @ORM\prePersist
